...
export function PageCanvas({ children, scroll = true }: PageCanvasProps) {
  ...
  return (
    <div className="relative flex h-full min-h-0 w-full flex-col">
      <div
        className="pointer-events-none absolute inset-0 z-0 opacity-[0.48]"
        style={{ background: gradient }}
        aria-hidden
      />
      <div className="bud-motif-bg pointer-events-none absolute inset-0 z-0 opacity-[0.07]" aria-hidden />
      <div
